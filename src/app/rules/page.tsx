import {
  ...
  export default function Home() {
    return (
      <Accordion type="single" collapsible className="mx-80">
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
          This league is a <strong>$25 buy-in</strong>. If you don't pay by the start of the NFL season (September 5th), you will be removed from the tournament.
          </AccordionContent>
          <AccordionContent>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
          <strong>Scoring format:</strong> Half PPR
          </AccordionContent>
          <AccordionContent>
